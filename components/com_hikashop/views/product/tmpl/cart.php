...
<?php
	...
	<div class="cart-mini-container">
		<div class="cart-mini-button">
			<a class="btn btn-success toggle-cart closed noselect"><i class="fa fa-shopping-cart">&nbsp;</i><span>&nbsp;View&nbsp;Cart</span></a>
		</div>
		<script type="text/javascript">jQuery(function(){var x=0;jQuery(".hikashop_cart_module .hikashop_product_quantity_field").each(function(){var i=parseInt(jQuery(this).val());x=x+i;});jQuery(".cart-total-qty").html("<span>"+x+"</span> Items");});</script>
		<div class="cart-mini-data">
